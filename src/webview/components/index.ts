...
<head>
	...
	<meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src 'unsafe-inline' https: vscode-webview:; script-src 'unsafe-inline' 'unsafe-eval' https: vscode-webview:; img-src data: https: blob: vscode-webview:; font-src data: https: vscode-webview:; connect-src https: wss: localhost:* http://localhost:*;">
