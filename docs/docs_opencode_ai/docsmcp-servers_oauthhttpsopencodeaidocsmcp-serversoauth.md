...
Если сервер требует аутентификации, opencode предложит вам пройти аутентификацию при первой попытке его использования. Если нет, вы можете [вручную запустить поток ](https://opencode.ai/docs/mcp-servers#authenticating) с помощью `opencode mcp auth <server-name>`.
* * *
...
* * *
#### [Отключение OAuth](https://opencode.ai/docs/mcp-servers#%D0%BE%D1%82%D0%BA%D0%BB%D1%8E%D1%87%D0%B5%D0%BD%D0%B8%D0%B5-oauth)
...
* * *
#### [Параметры OAuth](https://opencode.ai/docs/mcp-servers#%D0%BF%D0%B0%D1%80%D0%B0%D0%BC%D0%B5%D1%82%D1%80%D1%8B-oauth)
...
#### [Отладка](https://opencode.ai/docs/mcp-servers#%D0%BE%D1%82%D0%BB%D0%B0%D0%B4%D0%BA%D0%B0)
