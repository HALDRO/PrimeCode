...
* * *
#### [Параметры](https://opencode.ai/docs/mcp-servers#%D0%BF%D0%B0%D1%80%D0%B0%D0%BC%D0%B5%D1%82%D1%80%D1%8B-1)
...
`oauth` | Объект |  | Конфигурация аутентификации OAuth. См. раздел [OAuth](https://opencode.ai/docs/mcp-servers#oauth) ниже.  
