...
* * *
#### [login](https://opencode.ai/docs/ru/cli#login)
...
* * *
#### [list](https://opencode.ai/docs/ru/cli#list-1)
...
* * *
#### [logout](https://opencode.ai/docs/ru/cli#logout)
...
* * *
#### [install](https://opencode.ai/docs/ru/cli#install)
...
* * *
#### [run](https://opencode.ai/docs/ru/cli#run)
...
##### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-2)
Флаг | Описание  
---|---  
...
* * *
#### [add](https://opencode.ai/docs/ru/cli#add)
...
* * *
#### [list](https://opencode.ai/docs/ru/cli#list-2)
...
* * *
#### [auth](https://opencode.ai/docs/ru/cli#auth-1)
...
* * *
#### [logout](https://opencode.ai/docs/ru/cli#logout-1)
...
* * *
#### [debug](https://opencode.ai/docs/ru/cli#debug)
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-3)
Флаг | Описание  
---|---  
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-5)
Флаг | Описание  
---|---  
...
* * *
#### [list](https://opencode.ai/docs/ru/cli#list-3)
...
##### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-6)
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-7)
Флаг | Описание  
---|---  
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-8)
Флаг | Описание  
---|---  
`--port` | Порт для прослушивания  
`--hostname` | Имя хоста для прослушивания  
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-9)
Флаг | Описание  
---|---  
`--cwd` | Рабочий каталог  
`--port` | Порт для прослушивания  
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-10)
Флаг | Короткий | Описание  
---|---|---  
...
#### [Флаги](https://opencode.ai/docs/ru/cli#%D1%84%D0%BB%D0%B0%D0%B3%D0%B8-11)
Флаг | Короткий | Описание  
---|---|---  
