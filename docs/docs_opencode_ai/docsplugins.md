...
[Перейти к содержимому](https://opencode.ai/docs/plugins#_top)
...
На этой странице
Обзор 
  * [ Обзор ](https://opencode.ai/docs/plugins#_top)
...
Для примера ознакомьтесь с [plugins](https://opencode.ai/docs/ecosystem#plugins), созданными сообществом.
* * *