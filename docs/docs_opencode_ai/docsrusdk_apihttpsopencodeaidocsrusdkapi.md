...
## [API](https://opencode.ai/docs/ru/sdk#api)
SDK предоставляет все серверные API через типобезопасный клиент.
* * *

### [Глобальный](https://opencode.ai/docs/ru/sdk#%D0%B3%D0%BB%D0%BE%D0%B1%D0%B0%D0%BB%D1%8C%D0%BD%D1%8B%D0%B9)
Метод | Описание | Ответ  
---|---|---  
`global.health()` | Check server health and version | `{ healthy: true, version: string }`  
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B)
```
...
### [Приложение](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BB%D0%BE%D0%B6%D0%B5%D0%BD%D0%B8%D0%B5)
Метод | Описание | Ответ  
---|---|---  
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-1)
```
...
### [Проект](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82)
Метод | Описание | Ответ  
---|---|---  
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-2)
```
...
### [Путь](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%83%D1%82%D1%8C)
Метод | Описание | Ответ  
---|---|---  
`path.get()` | Get current path | [`Path`](https://github.com/anomalyco/opencode/blob/dev/packages/sdk/js/src/gen/types.gen.ts)  
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-3)
```
...
### [Конфигурация](https://opencode.ai/docs/ru/sdk#%D0%BA%D0%BE%D0%BD%D1%84%D0%B8%D0%B3%D1%83%D1%80%D0%B0%D1%86%D0%B8%D1%8F-1)
Метод | Описание | Ответ  
---|---|---  
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-4)
```
...
### [Сессии](https://opencode.ai/docs/ru/sdk#%D1%81%D0%B5%D1%81%D1%81%D0%B8%D0%B8)
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-5)
```
...
### [Файлы](https://opencode.ai/docs/ru/sdk#%D1%84%D0%B0%D0%B9%D0%BB%D1%8B)
Метод | Описание | Ответ  
---|---|---  
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-6)
```
...
### [TUI](https://opencode.ai/docs/ru/sdk#tui)
Метод | Описание | Ответ  
---|---|---  
...
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-7)
```
...
### [Аутентификация](https://opencode.ai/docs/ru/sdk#%D0%B0%D1%83%D1%82%D0%B5%D0%BD%D1%82%D0%B8%D1%84%D0%B8%D0%BA%D0%B0%D1%86%D0%B8%D1%8F)
Метод | Описание | Ответ  
---|---|---  
`auth.set({ ... })` | Set authentication credentials | `boolean`  
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-8)
```
...
### [События](https://opencode.ai/docs/ru/sdk#%D1%81%D0%BE%D0%B1%D1%8B%D1%82%D0%B8%D1%8F)
Метод | Описание | Ответ  
---|---|---  
`event.subscribe()` | Server-sent events stream | Server-sent events stream  
* * *
#### [Примеры](https://opencode.ai/docs/ru/sdk#%D0%BF%D1%80%D0%B8%D0%BC%D0%B5%D1%80%D1%8B-9)
```
